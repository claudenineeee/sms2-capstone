        ...
        if ($formError === '') {
            ...
            if (!$row) {
                ...
                if (!$isEditable) {
                    ...
                    $reqFacId = (int) $row['faculty_id'];
                    $owns = ($facultyRecordId > 0 && $reqFacId === $facultyRecordId) || ($facultyProfileId > 0 && $reqFacId === $facultyProfileId);
                    if (!$owns) {
                        ...
                        $fp->execute([':faculty_id' => $reqFacId, ':user_id' => $userId]);

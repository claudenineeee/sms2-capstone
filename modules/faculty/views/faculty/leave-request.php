...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
        ...
        <p class="text-secondary small mb-0">Submit new leave applications and track your approval history (7 Days Max
            Per Semester)</p>
    </div>
    ...
    <?php else: ?>
        <button class="btn btn-secondary rounded-pill px-3 shadow-sm d-flex align-items-center gap-2 fw-medium" disabled
            title="You have exhausted your 7-day leave limit for this semester">
            ...
            <div class="card-body d-flex align-items-center ps-4">
                ...
                <div>
                    ...
                    <h4 class="mb-0 fw-bold" style="color: #0d6efd;"><?php echo $maxSemesterDays; ?> <small
                            class="text-muted fs-6">days limit</small></h4>
                </div>
            </div>
        </section>
    </div>
            ...
            <div class="card-body d-flex align-items-center ps-4">
                ...
                <div>
                    ...
                    <h4 class="mb-0 fw-bold" style="color: #dc3545;">
                        <?php echo $pendingCount + $documentRequiredCount; ?> <small
                            class="text-muted fs-6">requests</small>
                    </h4>
                </div>
            </div>
        </section>
                                    ...
                                    <div class="d-inline-flex gap-1">
                                        <?php if ($isReturned): ?>
                                            <button class="btn btn-sm btn-warning rounded-circle"
                                                title="Edit & Resubmit Document/Reason" onclick='editDetails(<?= htmlspecialchars(json_encode([
                                                    'db_id' => $dbId,
                                                    'id' => $id,
                                                    'type' => $type,
                                                    'start' => $start,
                ...
                <form id="leaveRequestForm" method="post" enctype="multipart/form-data">
                    <div class="modal-body p-4">
                        ...
                        <div
                            ...
                            <span>You have <strong><?php echo $remainingSemesterDays; ?> available days</strong> left out of
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            ...
            <form id="editLeaveRequestForm" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label small fw-medium">Replace Supporting Document <span
                                class="text-danger">*</span></label>

...
<div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4">
    <div>
        ...
        <p class="text-secondary small mb-0">Submit new leave applications and track your balances for the <strong><?= htmlspecialchars($academicYear) ?></strong> academic year.</p>
    </div>
...
<div class="row g-3 mb-4">
    ...
    <div class="col-12 col-sm-6 col-xl-3">
        <section class="card stat-card success border shadow-sm position-relative overflow-hidden h-100"
                 ...
                 data-bs-target="#balanceBreakdownModal"
                        ...
                        <tr>
                            ...
                            <td class="pe-4 text-end">
                                <div class="d-inline-flex gap-1">
                                    <?php if ($isReturned): ?>
                                        <button class="btn btn-sm btn-warning rounded-circle" title="Edit & Resubmit"
                                                onclick='editDetails(<?= htmlspecialchars(json_encode([
                                                    'db_id'  => $dbId,
                                                    'id'     => $refId,
                                                    'type'   => $type,
                                                    'start'  => $start,

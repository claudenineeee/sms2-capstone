...
<div class="student-portal doc-vault-wrap">
    ...
    <form class="doc-vault-form" id="docVaultForm" method="post" action="" enctype="multipart/form-data">
        ...
        <div class="doc-requirement-note-wrap">
            <div id="docRequirementNotice" class="doc-requirement-note<?= $uploadError !== '' ? ' is-error' : '' ?>" role="status" aria-live="polite">
                <i id="docRequirementIcon" class="fas <?= $uploadError !== '' ? 'fa-triangle-exclamation' : 'fa-circle-info' ?>"></i>
                <div>
                    <strong id="docRequirementTitle"><?= $uploadError !== '' ? 'Form packet was not submitted.' : 'Before sending to CRAD' ?></strong>
